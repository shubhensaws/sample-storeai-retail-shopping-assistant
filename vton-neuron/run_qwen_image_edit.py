"""
Qwen-Image-Edit-2511 Inference Script for AWS Trainium2
...
print(f"Neuron runtime configured: world_size={WORLD_SIZE}, LNC=2")
...
HUGGINGFACE_CACHE_DIR = "/mnt/nvme/qwen_image_edit_hf_cache_dir"
...
def load_all_compiled_models(compiled_models_dir: str, pipe, args):
    ...
    if use_cpu_vision_encoder:
        ...
        print(f"  Loading vision encoder (TP) from {vision_encoder_tp_path}...")
        compiled_vision_encoder = neuronx_distributed.trace.parallel_model_load(
            vision_encoder_tp_path
        )
        print(f"  Vision encoder loaded (TP)!")
    else:

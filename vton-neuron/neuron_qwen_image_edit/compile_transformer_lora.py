...
Usage:
    python compile_transformer_lora.py \
        ...
        --patch_multiplier 3 \
        --compiled_models_dir /mnt/nvme/compiled_models_lora
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--compiled_models_dir", type=str, default="/mnt/nvme/compiled_models_lora")
    parser.add_argument("--compiler_workdir", type=str, default="/mnt/nvme/compiler_workdir_lora")
